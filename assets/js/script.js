  ...
  Papa.parse('./assets/zips/us-zips-02-2024.csv', {
    ...
    complete: function (results) {
      ...
      const sortedDistances = distances.sort(
        (a, b) =>
          parseFloat(a[header.indexOf('Distance Miles')]) -
          parseFloat(b[header.indexOf('Distance Miles')])
      );
...
// Haverson formula to calculate distance between two points
...
function generateCSV(data, fromZip) {
  ...
  document.getElementById('result').innerHTML =
    '<div class="mt-2"><strong><a href="' +
    encodedUri +
    '" download>Download Output CSV</strong></a>';
}
